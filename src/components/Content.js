...
export default function Carrousel(props) {
    ...
    function rating(value) {
        ...
        for(let n=0; n < total; n++)
        {
            if(n < rate)
            {
                stars.push(<span key={ n }><img src={ starFull } className="star" alt="étoile pleine" /></span>)
            }
            else
            {
                stars.push(<span key={ n }><img src={ starEmpty } className="star" alt="étoile vide" /></span>)
            }
        }
    }
